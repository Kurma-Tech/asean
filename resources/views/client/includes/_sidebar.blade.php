            ...
            <div class="sidebar">
                ...
                <div class="form-inline my-2">
                    <div class="input-group" data-widget="sidebar-search">
                        <input class="form-control form-control-sidebar" type="search" placeholder="Search" aria-label="Search" wire:model.debounce.300ms='filter'>
                    </div>
                </div>
                    ...
                    <div class="tab-pane fade show active" id="business" role="tabpanel" aria-labelledby="business-tab">
                        <div class="card">
                            <div class="card-body py-2">
                                <h4 class="title mb-0">Car Pvt. Ltd.</h4>
                        ...
                        <div class="card">
                            <div class="card-body py-2">
                                <h4 class="title mb-0">Information Technology</h4>
                                <p class="mb-0">Location, Address</p>
                                <p class="mb-0">Automobile Industry</p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body py-2">
                                <h4 class="title mb-0">Man Power</h4>
                                <p class="mb-0">Location, Address</p>
                                <p class="mb-0">Automobile Industry</p>
                            </div>
                        </div>
