        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-info pt-2 pb-2">
                    <h4 class="modal-title text-white" style="font-size: 15px;">Import Patent Kind</h4>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent='patentKindImport'>
                    ...
                    <div class="modal-footer justify-content-end pt-1 pb-1">
                        ...
                        <button type="submit" class="btn btn-sm btn-info pt-1 pb-1">Kind Import</button>
                    </div>
                </form>
            </div>
            <!-- /.modal-content -->
