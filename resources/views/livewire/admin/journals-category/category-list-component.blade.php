@section('title', 'Journals Category List')
        ...
        <div class="container-fluid">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" style="width: 100%;" wire:model="orderBy">
                                            ...
                                            <option value="ajcs_code">AJCS Code</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="row">
                <div class="col-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ $btnType }} Journals Category</h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="ajcs_code">AJCS Code*</label>
                                                <input type="text" class="form-control" id="ajcs_code" placeholder="Enter Code" wire:model='ajcs_code'>
                                                @error('ajcs_code')
                                                <div class="error">{{ $message }}</div>
                                                @enderror
                                            </div>
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Title</th>
                                        <th style="width: 10%;">AJCS Code</th>
            ...
            @livewire('admin.journals-category.import-component')
