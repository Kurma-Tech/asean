        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ $btnType }} Area Code</h3>
                        ...
                        <form wire:submit.prevent="storeArea">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="area_name" placeholder="Ex. Region I (PH)"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="area_code" placeholder="Ex. 10 (2 digits)"
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-success btn-sm">{{ $btnType }} Area Code</button>
                ...
                <div class="col-8 col-md-8 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Area Code List</h3>
                        </div>
                        <!-- ./card-header -->
                        <div class="card-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-info">{{ $area->country->name ?? 'NULL' }}</span></td>
                                        <td><span class="badge badge-secondary">{{ $area->area_name ?? 'NULL' }}</span></td>
                                        <td><span class="badge badge-warning">{{ $area->area_code ?? 'NULL' }}</span></td>
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-xs bg-warning" wire:click="editForm({{$area->id}})"  data-toggle="tooltip" data-placement="top" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0)" onclick="confirm('Are you sure? Do you want to delete?') || event.stopImmediatePropagation()" class="btn btn-xs bg-danger" wire:click="softDelete({{$area->id}})" data-toggle="tooltip" data-placement="top" title="Delete">
                        ...
                        <div class="card-footer clearfix">
                            {{$areas->links('admin.render.admin-pagination-links')}}
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
            ...
            <!-- /.row -->
            @livewire('admin.country.area.import-component')
        </div><!-- /.container-fluid -->
    </div>
    <!-- /.content -->
</div>
