        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ $btnType }} City</h3>
                        ...
                        <form wire:submit.prevent="storeCity">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div wire:ignore>
                                        <select class="form-control select2 select2bs4" id="district_name" wire:model="district_id">
                                ...
                                <div class="form-group">
                                    <label for="code">City Code<span class="text-danger">*</span></label>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-success btn-sm">{{ $btnType }} City</button>
                ...
                <div class="col-8 col-md-8 col-sm-12">
                    <div class="card">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" onclick="confirm('Are you sure? Do you want to delete?') || event.stopImmediatePropagation()" class="btn btn-xs bg-danger" wire:click="softDelete({{$city->id}})" data-toggle="tooltip" data-placement="top" title="Delete">
                        ...
                        <div class="card-footer clearfix">
                            {{$cities->links('admin.render.admin-pagination-links')}}
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
            ...
            <!-- /.row -->
            @livewire('admin.country.city.import-component')
        </div><!-- /.container-fluid -->
    </div>
    <!-- /.content -->
</div>
