@section('title', 'Districts Trashed List')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Trashed District List</h3>
                        </div>
                        <!-- ./card-header -->
                        <div class="card-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach ($districts->where('deleted_at', '!=', Null) as $district)
                                    <tr>
                                        ...
                                        <td><span class="badge badge-secondary">{{ $district->provinces->regions->country->name ?? 'NULL' }} > {{ $district->province->regions->name ?? 'NULL' }} > {{ $district->province->name ?? 'NULL' }}</span></td>
                                        <td>
                                            <a href="javascript:void(0)" onclick="confirm('Do you want to restore?') || event.stopImmediatePropagation()" class="btn btn-xs bg-success" wire:click="restore({{$district->id}})" data-toggle="tooltip" data-placement="top" title="Restore">
