        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ $btnType }} Province</h3>
                        ...
                        <form wire:submit.prevent="storeProvince">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Enter Province Name"
                                        wire:model='name'>
                                    @error('name')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <label for="code">Province Code<span class="text-danger">*</span></label>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-success btn-sm">{{ $btnType }} Province</button>
                ...
                <div class="col-8 col-md-8 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Provinces List</h3>
                        </div>
                        <!-- ./card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" onclick="confirm('Are you sure? Do you want to delete?') || event.stopImmediatePropagation()" class="btn btn-xs bg-danger" wire:click="softDelete({{$province->id}})" data-toggle="tooltip" data-placement="top" title="Delete">
            ...
            <!-- /.row -->
            @livewire('admin.country.province.import-component')
        </div><!-- /.container-fluid -->
    </div>
    <!-- /.content -->
</div>
