@section('title', 'Intellectual Property Type Trashed List')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Trashed Intellectual Property Type List</h3>
                        </div>
                        <!-- ./card-header -->
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" onclick="confirm('Do you want to restore?') || event.stopImmediatePropagation()" 
                                                class="btn btn-xs bg-success" wire:click="restore({{$pType->id}})" 
