...
class ReportController extends Controller
{
    ...
    public function getEmergingCategoryData(Request $request)
    {
        ...
        if ($requestedData["dataType"] == "business") {
            $data = Cache::remember('business'.(isset($requestedData["country"]) ? ($requestedData["country"]) : "").(isset($requestedData["young"]) ? ($requestedData["young"]) : ""), 2592000  , function () use ($requestedData){
                if (isset($requestedData["country"]) && $requestedData["country"] != null) {
        ...
        if ($requestedData["dataType"] == "patent") {
            $data = Cache::remember('patent'.(isset($requestedData["country"]) ? ($requestedData["country"]) : "").(isset($requestedData["young"]) ? ($requestedData["young"]) : ""), 2592000, function () use ($requestedData) {
                if (isset($requestedData["country"]) && $requestedData["country"] != null) {
        ...
        if ($requestedData["dataType"] == "journal") {
            $data = Cache::remember('journal'.(isset($requestedData["country"]) ? ($requestedData["country"]) : "").(isset($requestedData["young"]) ? ($requestedData["young"]) : ""), 2592000  , function () use ($requestedData) {
                if (isset($requestedData["country"]) && $requestedData["country"] != null) {
