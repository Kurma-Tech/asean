...
class ImportComponent extends Component
{
    ...
    {
        return view('livewire.admin.country.city.import-component');
    }
    ...
    public function cityImport()
    {
        ...
        try {
            set_time_limit(0);
            Excel::import(new CityImport, $this->file);

            DB::commit();
            
            $this->reset();
            $this->success = 'City Imported Successfully';
    ...
    public function downloadSample()
    {
        try{
            ...
            $this->success = 'City Sample Downloaded';
            $this->dispatchBrowserEvent('success-message',['message' => $this->success]);
        } catch (\Throwable $th) {
            DB::rollback();
            $this->error = 'Ops! looks like we had some problem';
