...
class DistrictTrashedComponent extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.admin.country.district.district-trashed-component', [
    ...
    public function delete($id)
    {
        try {
            ...
            if ($data != null) {
                $data->forceDelete();
                $this->dispatchBrowserEvent('success-message',['message' => 'District permanently deleted successfully']);
            }else{
