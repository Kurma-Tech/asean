...
class RegionTrashedComponent extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.admin.country.region.region-trashed-component', [
    ...
    public function delete($id)
    {
        try {
            ...
            if ($data != null) {
                $data->forceDelete();
                $this->dispatchBrowserEvent('success-message',['message' => 'Region permanently deleted successfully']);
            }else{
