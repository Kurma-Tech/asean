...
class TrashedComponent extends Component
{
    ...
    {
        return view('livewire.admin.journals-category.trashed-component', [
    ...
    {
        try {
            $data = JournalCategory::where('id', $id);
            if ($data != null) {
                $data->forceDelete();
                $this->dispatchBrowserEvent('success-message', ['message' => 'Category permanently deleted successfully']);
            } else {
